...
<form method="POST" action="{{ route('admin.agenda.update', $agenda->id) }}">
    ...
    <div class="mb-3">
        ...
        <textarea name="meta_desc" class="form-control" rows="2" placeholder="Deskripsi singkat agenda untuk hasil pencarian Google">{{ old('meta_desc', $agenda->meta_desc) }}</textarea>
    ...
    <div class="mb-3">
        ...
        <input type="text" name="meta_key" class="form-control" value="{{ old('meta_key', $agenda->meta_key) }}" placeholder="kata kunci, dipisah, koma">
    ...
    <div class="mb-3">
        ...
        <textarea name="meta_text" class="form-control" rows="2" placeholder="Teks meta tambahan (jika diperlukan)">{{ old('meta_text', $agenda->meta_text) }}</textarea>
